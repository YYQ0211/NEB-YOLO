...
parser.add_argument('--xml_path', default=r'VOC2007/Annotations', type=str, help='input xml label path')
# 数据集的划分，地址选择自己数据下的ImageSets/Main
parser.add_argument('--txt_path', default=r'VOC2007/ImageSets/Main', type=str, help='output txt label path')
